...
public class ArchitectureFactoryImpl extends EFactoryImpl implements ArchitectureFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ArchitecturePackage.ARCHITECTURE_METHOD: return createArchitectureMethod();
			case ArchitecturePackage.ARCHITECTURE_ATTRIBUTE: return createArchitectureAttribute();
			case ArchitecturePackage.CODE_PIECE: return createCodePiece();
			default:
	 ...
	 * @generated
	 */
	public ArchitectureMethod createArchitectureMethod() {
		ArchitectureMethodImpl architectureMethod = new ArchitectureMethodImpl();
		return architectureMethod;
	}
	 ...
	 * @generated
	 */
	public ArchitectureAttribute createArchitectureAttribute() {
		ArchitectureAttributeImpl architectureAttribute = new ArchitectureAttributeImpl();
		return architectureAttribute;
	}
	 ...
	 * @generated
	 */
	public CodePiece createCodePiece() {
		CodePieceImpl codePiece = new CodePieceImpl();
		return codePiece;
	}
