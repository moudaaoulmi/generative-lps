...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.SPLAnalyser.core.models.impactanalysismodel.Feature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsAlternativePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ImpactanalysismodelPackage.Literals.FEATURE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ImpactanalysismodelPackage.Literals.FEATURE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ImpactanalysismodelPackage.Literals.FEATURE__CONSTRAINTS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Is Alternative feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsAlternativePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Feature_isAlternative_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Feature_isAlternative_feature", "_UI_Feature_type"),
				 ImpactanalysismodelPackage.Literals.FEATURE__IS_ALTERNATIVE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ImpactanalysismodelPackage.Literals.FEATURE__FEATURE_CHILD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ImpactanalysismodelPackage.Literals.FEATURE__FEATURE_CHILD,
