...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Removed Entities</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link br.pucrio.inf.les.SPLAnalyser.core.models.deltamodel.impl.RemovedEntitiesImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link br.pucrio.inf.les.SPLAnalyser.core.models.deltamodel.impl.RemovedEntitiesImpl#getAssets <em>Assets</em>}</li>
 *   <li>{@link br.pucrio.inf.les.SPLAnalyser.core.models.deltamodel.impl.RemovedEntitiesImpl#getUseCases <em>Use Cases</em>}</li>
 *   <li>{@link br.pucrio.inf.les.SPLAnalyser.core.models.deltamodel.impl.RemovedEntitiesImpl#getMappings <em>Mappings</em>}</li>
 *   <li>{@link br.pucrio.inf.les.SPLAnalyser.core.models.deltamodel.impl.RemovedEntitiesImpl#getAssetDependencies <em>Asset Dependencies</em>}</li>
 *   <li>{@link br.pucrio.inf.les.SPLAnalyser.core.models.deltamodel.impl.RemovedEntitiesImpl#getFeatureConstraints <em>Feature Constraints</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RemovedEntitiesImpl extends EObjectImpl implements RemovedEntities {
	/**
	...
	protected EClass eStaticClass() {
		return DeltamodelPackage.Literals.REMOVED_ENTITIES;
	}
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<Feature>(Feature.class, this, DeltamodelPackage.REMOVED_ENTITIES__FEATURES);
		}
		return features;
	}
	...
	public EList<Asset> getAssets() {
		if (assets == null) {
			assets = new EObjectContainmentEList<Asset>(Asset.class, this, DeltamodelPackage.REMOVED_ENTITIES__ASSETS);
		}
		return assets;
	}
	...
	public EList<UseCase> getUseCases() {
		if (useCases == null) {
			useCases = new EObjectContainmentEList<UseCase>(UseCase.class, this, DeltamodelPackage.REMOVED_ENTITIES__USE_CASES);
		}
		return useCases;
	}
	...
	public EList<Mapping> getMappings() {
		if (mappings == null) {
			mappings = new EObjectContainmentEList<Mapping>(Mapping.class, this, DeltamodelPackage.REMOVED_ENTITIES__MAPPINGS);
		}
		return mappings;
	}
	...
	public EList<Dependencie> getAssetDependencies() {
		if (assetDependencies == null) {
			assetDependencies = new EObjectContainmentEList<Dependencie>(Dependencie.class, this, DeltamodelPackage.REMOVED_ENTITIES__ASSET_DEPENDENCIES);
		}
	...
	public EList<Constraint> getFeatureConstraints() {
		if (featureConstraints == null) {
			featureConstraints = new EObjectContainmentEList<Constraint>(Constraint.class, this, DeltamodelPackage.REMOVED_ENTITIES__FEATURE_CONSTRAINTS);
		}
