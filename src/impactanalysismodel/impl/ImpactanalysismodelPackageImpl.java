...
public class ImpactanalysismodelPackageImpl extends EPackageImpl implements ImpactanalysismodelPackage {
	 ...
	 * @see impactanalysismodel.ImpactanalysismodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getField_ClassDependencies() {
	 ...
	 * @generated
	 */
	public EReference getMethod_MethodDependencies() {
	 ...
	 * @generated
	 */
	public EReference getMethod_FieldDependencies() {
	 ...
	 * @generated
	 */
	public EReference getMethod_ClassDependencies() {
	 ...
	 * @generated
	 */
	public EReference getClass_ClassDependencies() {
	 ...
	 * @generated
	 */
	public EReference getClass_FieldDependencies() {
	 ...
	 * @generated
	 */
	public EReference getClass_MethodDependencies() {
	...
	public void createPackageContents() {
		...
		createEReference(fieldEClass, FIELD__CLASS_DEPENDENCIES);

		methodEClass = createEClass(METHOD);
		createEReference(methodEClass, METHOD__METHOD_DEPENDENCIES);
		createEReference(methodEClass, METHOD__FIELD_DEPENDENCIES);
		createEReference(methodEClass, METHOD__CLASS_DEPENDENCIES);

		classEClass = createEClass(CLASS);
		createEReference(classEClass, CLASS__DECLARED_METHODS);
		createEReference(classEClass, CLASS__DECLARED_FIELDS);
		createEReference(classEClass, CLASS__CLASS_DEPENDENCIES);
		createEReference(classEClass, CLASS__FIELD_DEPENDENCIES);
		createEReference(classEClass, CLASS__METHOD_DEPENDENCIES);
	...
	public void initializePackageContents() {
		...
		initEReference(getField_ClassDependencies(), this.getClass_(), null, "ClassDependencies", null, 0, -1, Field.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(methodEClass, Method.class, "Method", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMethod_MethodDependencies(), this.getMethod(), null, "MethodDependencies", null, 0, -1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMethod_FieldDependencies(), this.getField(), null, "FieldDependencies", null, 0, -1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMethod_ClassDependencies(), this.getClass_(), null, "ClassDependencies", null, 0, -1, Method.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classEClass, impactanalysismodel.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClass_DeclaredMethods(), this.getMethod(), null, "DeclaredMethods", null, 0, -1, impactanalysismodel.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_DeclaredFields(), this.getField(), null, "DeclaredFields", null, 0, -1, impactanalysismodel.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_ClassDependencies(), this.getClass_(), null, "ClassDependencies", null, 0, -1, impactanalysismodel.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_FieldDependencies(), this.getField(), null, "FieldDependencies", null, 0, -1, impactanalysismodel.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_MethodDependencies(), this.getMethod(), null, "MethodDependencies", null, 0, -1, impactanalysismodel.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
