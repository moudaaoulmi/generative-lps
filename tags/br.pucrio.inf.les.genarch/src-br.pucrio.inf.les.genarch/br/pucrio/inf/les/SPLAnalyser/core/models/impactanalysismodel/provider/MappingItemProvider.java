...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.SPLAnalyser.core.models.impactanalysismodel.Mapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ImpactanalysismodelPackage.Literals.MAPPING__FEATURES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAssetsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mapping_Assets_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mapping_Assets_feature", "_UI_Mapping_type"),
				 ImpactanalysismodelPackage.Literals.MAPPING__ASSETS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUseCasesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mapping_UseCases_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mapping_UseCases_feature", "_UI_Mapping_type"),
				 ImpactanalysismodelPackage.Literals.MAPPING__USE_CASES,
				 true,
				 false,
				 true,
				 null,
