...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.SPLAnalyser.core.models.deltamodel.FeatureChange} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureChangeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FeatureChange_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureChange_Name_feature", "_UI_FeatureChange_type"),
				 DeltamodelPackage.Literals.FEATURE_CHANGE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPreviousValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FeatureChange_PreviousValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureChange_PreviousValue_feature", "_UI_FeatureChange_type"),
				 DeltamodelPackage.Literals.FEATURE_CHANGE__PREVIOUS_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addNewValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FeatureChange_NewValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureChange_NewValue_feature", "_UI_FeatureChange_type"),
				 DeltamodelPackage.Literals.FEATURE_CHANGE__NEW_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((FeatureChange)object).getName();
