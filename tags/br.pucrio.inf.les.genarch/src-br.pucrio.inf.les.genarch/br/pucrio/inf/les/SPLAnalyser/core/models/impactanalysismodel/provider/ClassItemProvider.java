...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.SPLAnalyser.core.models.impactanalysismodel.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Class_Modifiers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Class_Modifiers_feature", "_UI_Class_type"),
				 ImpactanalysismodelPackage.Literals.CLASS__MODIFIERS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ImpactanalysismodelPackage.Literals.CLASS__DECLARED_METHODS);
			childrenFeatures.add(ImpactanalysismodelPackage.Literals.CLASS__DECLARED_FIELDS);
		}
	...
	public String getText(Object object) {
		String label = ((br.pucrio.inf.les.SPLAnalyser.core.models.impactanalysismodel.Class)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(br.pucrio.inf.les.SPLAnalyser.core.models.impactanalysismodel.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ImpactanalysismodelPackage.Literals.CLASS__DECLARED_METHODS,
				 ImpactanalysismodelFactory.eINSTANCE.createMethod()));

		newChildDescriptors.add
			(createChildParameter
				(ImpactanalysismodelPackage.Literals.CLASS__DECLARED_FIELDS,
