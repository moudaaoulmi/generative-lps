...
public class ConfigurationSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ConfigurationPackage.CONFIGURATION_FIELD: {
				ConfigurationField configurationField = (ConfigurationField)theEObject;
				Object result = caseConfigurationField(configurationField);
				if (result == null) result = caseMappingEntity(configurationField);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ConfigurationPackage.CONFIGURATION_METHOD: {
				ConfigurationMethod configurationMethod = (ConfigurationMethod)theEObject;
				Object result = caseConfigurationMethod(configurationMethod);
				if (result == null) result = caseMappingEntity(configurationMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigurationPackage.CONFIGURATION_CODE_PIECE: {
				ConfigurationCodePiece configurationCodePiece = (ConfigurationCodePiece)theEObject;
				Object result = caseConfigurationCodePiece(configurationCodePiece);
				if (result == null) result = caseMappingEntity(configurationCodePiece);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public Object caseConfigurationField(ConfigurationField object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public Object caseConfigurationMethod(ConfigurationMethod object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Code Piece</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Code Piece</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public Object caseConfigurationCodePiece(ConfigurationCodePiece object) {
		return null;
	}
