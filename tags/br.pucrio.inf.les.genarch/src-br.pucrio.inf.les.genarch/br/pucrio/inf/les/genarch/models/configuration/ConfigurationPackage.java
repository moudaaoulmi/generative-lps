...
public interface ConfigurationPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Code Pieces</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CONFIGURATION_METHOD__CODE_PIECES = MAPPING_ENTITY_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CONFIGURATION_METHOD_FEATURE_COUNT = MAPPING_ENTITY_FEATURE_COUNT + 2;

	/**
	 * The meta object id for the '{@link br.pucrio.inf.les.genarch.models.configuration.impl.ConfigurationCodePieceImpl <em>Code Piece</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see br.pucrio.inf.les.genarch.models.configuration.impl.ConfigurationCodePieceImpl
	 * @see br.pucrio.inf.les.genarch.models.configuration.impl.ConfigurationPackageImpl#getConfigurationCodePiece()
	 * @generated
	 */
	int CONFIGURATION_CODE_PIECE = 16;
	 ...
	 * @ordered
	 */
	int CONFIGURATION_CODE_PIECE__NAME = MAPPING_ENTITY__NAME;
	 ...
	 * @ordered
	 */
	int CONFIGURATION_CODE_PIECE__PATH = MAPPING_ENTITY__PATH;
	 ...
	 * @ordered
	 */
	int CONFIGURATION_CODE_PIECE__FEATURE_EXPRESSION = MAPPING_ENTITY__FEATURE_EXPRESSION;
	 ...
	 * @ordered
	 */
	int CONFIGURATION_CODE_PIECE__CODE_PIECES = MAPPING_ENTITY_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CONFIGURATION_CODE_PIECE_FEATURE_COUNT = MAPPING_ENTITY_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link br.pucrio.inf.les.genarch.models.configuration.ConfigurationMethod#getCodePieces <em>Code Pieces</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Code Pieces</em>'.
	 * @see br.pucrio.inf.les.genarch.models.configuration.ConfigurationMethod#getCodePieces()
	 * @see #getConfigurationMethod()
	 * @generated
	 */
	EReference getConfigurationMethod_CodePieces();

	/**
	 * Returns the meta object for class '{@link br.pucrio.inf.les.genarch.models.configuration.ConfigurationCodePiece <em>Code Piece</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Code Piece</em>'.
	 * @see br.pucrio.inf.les.genarch.models.configuration.ConfigurationCodePiece
	 * @generated
	 */
	EClass getConfigurationCodePiece();

	/**
	 * Returns the meta object for the containment reference list '{@link br.pucrio.inf.les.genarch.models.configuration.ConfigurationCodePiece#getCodePieces <em>Code Pieces</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Code Pieces</em>'.
	 * @see br.pucrio.inf.les.genarch.models.configuration.ConfigurationCodePiece#getCodePieces()
	 * @see #getConfigurationCodePiece()
	 * @generated
	 */
	EReference getConfigurationCodePiece_CodePieces();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Code Pieces</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CONFIGURATION_METHOD__CODE_PIECES = eINSTANCE.getConfigurationMethod_CodePieces();

		/**
		 * The meta object literal for the '{@link br.pucrio.inf.les.genarch.models.configuration.impl.ConfigurationCodePieceImpl <em>Code Piece</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see br.pucrio.inf.les.genarch.models.configuration.impl.ConfigurationCodePieceImpl
		 * @see br.pucrio.inf.les.genarch.models.configuration.impl.ConfigurationPackageImpl#getConfigurationCodePiece()
		 * @generated
		 */
		EClass CONFIGURATION_CODE_PIECE = eINSTANCE.getConfigurationCodePiece();
		 ...
		 * @generated
		 */
		EReference CONFIGURATION_CODE_PIECE__CODE_PIECES = eINSTANCE.getConfigurationCodePiece_CodePieces();
