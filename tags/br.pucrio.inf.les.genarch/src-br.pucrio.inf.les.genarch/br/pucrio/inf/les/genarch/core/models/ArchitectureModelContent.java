...
public class ArchitectureModelContent {
    ...
    public ArchitectureMethod addMethod(String name,String declaration, String path, ArchitectureClass architectureClass) {
    ...
    public CodePiece addCodePiece(int start, int end, String path, String code, ArchitectureEntity parent) {
    	CodePiece codePiece = this.architectureFactory.createCodePiece();
    	codePiece.setName("");
    	codePiece.setStart(start);
    	codePiece.setEnd(end);
    	codePiece.setPath(path);
    	codePiece.setCode(code);
    	if(parent instanceof ArchitectureMethod)
    		((ArchitectureMethod)parent).getCodePieceRef().add(codePiece);
    	else if(parent instanceof CodePiece)
    		((CodePiece)parent).getCodePieceRef().add(codePiece);
    	return codePiece;
    }
