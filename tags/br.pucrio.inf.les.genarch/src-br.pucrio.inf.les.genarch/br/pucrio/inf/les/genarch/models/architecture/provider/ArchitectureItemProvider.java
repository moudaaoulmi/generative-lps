...
/**
 * This is the item provider adapter for a {@link br.pucrio.inf.les.genarch.models.architecture.Architecture} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchitectureItemProvider
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArchitecturePackage.Literals.ARCHITECTURE__CONTAINERS);
			childrenFeatures.add(ArchitecturePackage.Literals.ARCHITECTURE__RESOURCES_CONTAINER);
			childrenFeatures.add(ArchitecturePackage.Literals.ARCHITECTURE__FRAGMENTS_CONTAINER);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ARCHITECTURE__CONTAINERS,
				 ArchitectureFactory.eINSTANCE.createArchitectureContainer()));

		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ARCHITECTURE__RESOURCES_CONTAINER,
				 ArchitectureFactory.eINSTANCE.createArchitectureResourcesContainer()));

		newChildDescriptors.add
			(createChildParameter
				(ArchitecturePackage.Literals.ARCHITECTURE__FRAGMENTS_CONTAINER,
				 ArchitectureFactory.eINSTANCE.createArchitectureFragmentContainer()));
	}
