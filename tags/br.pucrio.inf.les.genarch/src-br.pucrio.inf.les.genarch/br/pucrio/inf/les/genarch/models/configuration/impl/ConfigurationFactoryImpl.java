...
public class ConfigurationFactoryImpl extends EFactoryImpl implements ConfigurationFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ConfigurationPackage.CONFIGURATION_FIELD: return createConfigurationField();
			...
			case ConfigurationPackage.CONFIGURATION_METHOD: return createConfigurationMethod();
			case ConfigurationPackage.CONFIGURATION_CODE_PIECE: return createConfigurationCodePiece();
			default:
	 ...
	 * @generated
	 */
	public ConfigurationMethod createConfigurationMethod() {
		ConfigurationMethodImpl configurationMethod = new ConfigurationMethodImpl();
	 ...
	 * @generated
	 */
	public ConfigurationCodePiece createConfigurationCodePiece() {
		ConfigurationCodePieceImpl configurationCodePiece = new ConfigurationCodePieceImpl();
		return configurationCodePiece;
	}
