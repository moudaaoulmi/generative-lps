...
public class ArchitectureSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArchitecturePackage.ARCHITECTURE_METHOD: {
				ArchitectureMethod architectureMethod = (ArchitectureMethod)theEObject;
				Object result = caseArchitectureMethod(architectureMethod);
				if (result == null) result = caseArchitectureEntity(architectureMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitecturePackage.ARCHITECTURE_ATTRIBUTE: {
				ArchitectureAttribute architectureAttribute = (ArchitectureAttribute)theEObject;
				Object result = caseArchitectureAttribute(architectureAttribute);
				if (result == null) result = caseArchitectureEntity(architectureAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitecturePackage.CODE_PIECE: {
				CodePiece codePiece = (CodePiece)theEObject;
				Object result = caseCodePiece(codePiece);
				if (result == null) result = caseArchitectureEntity(codePiece);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
