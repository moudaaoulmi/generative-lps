...
public class ArchitectureAdapterFactory extends AdapterFactoryImpl {
	...
	protected ArchitectureSwitch modelSwitch =
		new ArchitectureSwitch() {
			...
			public Object caseArchitectureMethod(ArchitectureMethod object) {
				return createArchitectureMethodAdapter();
			}
			public Object caseArchitectureAttribute(ArchitectureAttribute object) {
				return createArchitectureAttributeAdapter();
			}
			public Object caseCodePiece(CodePiece object) {
				return createCodePieceAdapter();
			}
	...
	/**
	 * Creates a new adapter for an object of class '{@link br.pucrio.inf.les.genarch.models.architecture.ArchitectureMethod <em>Method</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createArchitectureMethodAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link br.pucrio.inf.les.genarch.models.architecture.ArchitectureAttribute <em>Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createArchitectureAttributeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link br.pucrio.inf.les.genarch.models.architecture.CodePiece <em>Code Piece</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCodePieceAdapter() {
		return null;
	}
