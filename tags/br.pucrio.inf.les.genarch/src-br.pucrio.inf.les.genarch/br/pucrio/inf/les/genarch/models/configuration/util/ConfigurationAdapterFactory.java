...
public class ConfigurationAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConfigurationSwitch modelSwitch =
		new ConfigurationSwitch() {
			...
			public Object caseConfigurationMethod(ConfigurationMethod object) {
				return createConfigurationMethodAdapter();
			}
			public Object caseConfigurationCodePiece(ConfigurationCodePiece object) {
				return createConfigurationCodePieceAdapter();
			}
	...
	/**
	 * Creates a new adapter for an object of class '{@link br.pucrio.inf.les.genarch.models.configuration.ConfigurationField <em>Field</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link br.pucrio.inf.les.genarch.models.configuration.ConfigurationMethod <em>Method</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createConfigurationMethodAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link br.pucrio.inf.les.genarch.models.configuration.ConfigurationCodePiece <em>Code Piece</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createConfigurationCodePieceAdapter() {
		return null;
	}
