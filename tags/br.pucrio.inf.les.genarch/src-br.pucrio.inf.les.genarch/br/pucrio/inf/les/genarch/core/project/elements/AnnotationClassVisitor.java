...
public class AnnotationClassVisitor extends ASTVisitor {
	...
	private List<Javadoc> featureAnnotations = new ArrayList<Javadoc>();
	
	private List<FieldDeclaration> fields = new ArrayList<FieldDeclaration>();
	private List<MethodDeclaration> methods = new ArrayList<MethodDeclaration>();
	
	private List<Object> configurationModelNodes = new ArrayList<Object>();
	...
	public boolean visit(final ClassInstanceCreation node) {
		getConfigurationModelNodes().add(node);
		return this.visitNode(node);
	}
	@Override
	...
	public void setConfigurationModelNodes(List<Object> configurationModelNodes) {
		this.configurationModelNodes = configurationModelNodes;
	}

	public List<Object> getConfigurationModelNodes() {
		return configurationModelNodes;
	}
	
	public void setFeatureAnnotations(List<Javadoc> featureAnnotations) {
		this.featureAnnotations = featureAnnotations;
	}

	public List<Javadoc> getFeatureAnnotations() {
