...
public class ASTExplorerVisitor extends ASTVisitor {
	...
	private List<Object> applicableNodes = new ArrayList<Object>();
	...
	public boolean visit(Javadoc node) {
		if(node.getComment().toLowerCase().startsWith("/** #Feature".toLowerCase())
				|| node.getComment().toLowerCase().equals("/** #endFeature */".toLowerCase()) ){
	...
	public void endVisit(MethodDeclaration node) {
		node.toString();
//		((MethodDeclaration)node).getBody().getRoot();
//		((TypeDeclaration)node).getJavadoc();
//		if(node.getParent() instanceof TypeDeclaration){
//			System.out.println(" - "+(( TypeDeclaration )node.getParent()).getName());
//			
//			if ((( TypeDeclaration )node.getParent()).getName().toString().equals("MediaController"))
//					System.out.println("opa");
//		}
//		if(node.toString().toLowerCase().startsWith("/** #Feature".toLowerCase())){
//			featureAnnotations.add(node);
//		}
		// default implementation: do nothing
	}
	...
	public void setApplicableNodes(List<Object> allNodes) {
		this.applicableNodes = allNodes;
	}

	public List<Object> getApplicableNodes() {
