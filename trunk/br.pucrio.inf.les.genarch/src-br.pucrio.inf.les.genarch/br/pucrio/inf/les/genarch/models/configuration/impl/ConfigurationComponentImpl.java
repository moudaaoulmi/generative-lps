...
public class ConfigurationComponentImpl extends MappingEntityImpl implements ConfigurationComponent {
	...
	public EList getClasses() {
		if (classes == null) {
			classes = new EObjectContainmentEList(ConfigurationClass.class, this, ConfigurationPackage.CONFIGURATION_COMPONENT__CLASSES);
		}
		return classes;
	}
	...
	public EList getAspects() {
		if (aspects == null) {
			aspects = new EObjectContainmentEList(ConfigurationAspect.class, this, ConfigurationPackage.CONFIGURATION_COMPONENT__ASPECTS);
		}
		return aspects;
	}
	...
	public EList getTemplates() {
		if (templates == null) {
			templates = new EObjectContainmentEList(ConfigurationTemplate.class, this, ConfigurationPackage.CONFIGURATION_COMPONENT__TEMPLATES);
		}
		return templates;
	}
	...
	public EList getFiles() {
		if (files == null) {
			files = new EObjectContainmentEList(ConfigurationFile.class, this, ConfigurationPackage.CONFIGURATION_COMPONENT__FILES);
		}
		return files;
	}
	...
	public EList getSubComponents() {
		if (subComponents == null) {
			subComponents = new EObjectContainmentEList(ConfigurationComponent.class, this, ConfigurationPackage.CONFIGURATION_COMPONENT__SUB_COMPONENTS);
		}
