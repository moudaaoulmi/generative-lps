 ...
 * @generated
 */
public class ArchitectureAttributeTest extends ArchitectureEntityTest {
	...
	public static void main(String[] args) {
		TestRunner.run(ArchitectureAttributeTest.class);
	}
	 ...
	 * @generated
	 */
	public ArchitectureAttributeTest(String name) {
		super(name);
	}
	 ...
	 * @generated
	 */
	private ArchitectureAttribute getFixture() {
		return (ArchitectureAttribute)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(ArchitectureFactory.eINSTANCE.createArchitectureAttribute());
	}
